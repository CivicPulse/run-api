...
def upgrade() -> None:
    ...
    op.create_index(op.f("ix_signup_links_campaign_id"), "signup_links", ["campaign_id"], unique=False)
    op.create_index(op.f("ix_signup_links_token"), "signup_links", ["token"], unique=False)
