...
- [x] **Phase 100: Invite Delivery Visibility UI Closure** - Align the pending-invite frontend with the backend contract and surface support-facing delivery outcome details in the admin UI. (completed 2026-04-08)
