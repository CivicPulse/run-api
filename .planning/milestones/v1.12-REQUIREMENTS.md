# Requirements Archive: v1.12 Hardening & Remediation
...
This file records the shipped v1.12 requirements set and its final status at milestone completion.
...
- [x] **QUAL-05**: `useOrgPermissions` has unit tests covering the permission gates used by the root layout
