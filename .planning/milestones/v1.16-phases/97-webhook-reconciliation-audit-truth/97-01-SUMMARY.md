...
- Tightened [`app/api/v1/mailgun_webhooks.py`](/home/kwhatcher/projects/civicpulse/run-api/app/api/v1/mailgun_webhooks.py) so webhook reconciliation still projects delivery outcomes for attempts attached to campaigns without an organization foreign key, with regression coverage in [`tests/unit/test_mailgun_webhook.py`](/home/kwhatcher/projects/civicpulse/run-api/tests/unit/test_mailgun_webhook.py).
