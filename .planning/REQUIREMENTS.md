...
- [ ] **AUTH-01**: User can authenticate via ZITADEL OpenID Connect and receive a JWT
...
- [ ] **AUTH-04**: Campaign data is isolated via PostgreSQL Row-Level Security on campaign_id
