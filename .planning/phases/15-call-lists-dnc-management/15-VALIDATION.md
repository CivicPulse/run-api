...
| 15-01-02 | 01 | 0 | CALL-04, CALL-05, CALL-06, CALL-07 | unit | `npm run test -- --run useDNC` | ❌ W0 | ⬜ pending |
...
- [ ] `web/src/pages/DNCListPage.test.tsx` — stubs for CALL-08 (client-side filter)
