...
| 39-02-01 | 02 | 1 | DATA-03 | unit | `uv run pytest tests/unit/test_rls_middleware.py -x` | No -- Wave 0 | pending |
| 39-03-01 | 03 | 2 | DATA-04 | unit | `uv run pytest tests/unit/test_user_sync.py -x` | No -- Wave 0 | pending |
| 39-03-02 | 03 | 2 | DATA-05 | unit + integration | `uv run pytest tests/unit/test_campaign_list.py -x` | No -- Wave 0 | pending |
| 39-04-01 | 04 | 3 | DATA-06 | manual | Manual browser testing | N/A | pending |
