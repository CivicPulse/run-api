...
**Plans:** 3 plans
Plans:
- [ ] 56-01-PLAN.md — Backend API + service + tests for note edit/delete and walk list rename
- [ ] 56-02-PLAN.md — Frontend hooks + UI for note edit/delete and walk list rename
...
| 56. Feature Gap Builds | v1.7 | 0/3 | Not started | - |
