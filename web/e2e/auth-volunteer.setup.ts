...
setup("authenticate as volunteer", async ({ page }) => {
  ...
  await loginInput.fill(process.env.E2E_VOLUNTEER_USERNAME ?? "volunteer1@localhost")
  ...
  await passwordInput.fill(process.env.E2E_VOLUNTEER_PASSWORD ?? "Volunteer1234!")
