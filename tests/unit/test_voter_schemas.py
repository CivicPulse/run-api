...
class TestVoterResponseHasAllNewFields:
    ...
    def test_voter_response_has_propensity_fields(self):
        """VoterResponse exposes propensity fields."""
        from app.schemas.voter import VoterResponse
    ...
    def test_voter_response_has_demographic_fields(self):
        """VoterResponse exposes demographic fields."""
        from app.schemas.voter import VoterResponse
    ...
    def test_voter_response_has_household_fields(self):
        """VoterResponse exposes household fields."""
        from app.schemas.voter import VoterResponse
    ...
    def test_voter_response_does_not_have_old_address_fields(
        self,
    ):
        """VoterResponse does not expose legacy address
        fields."""
        from app.schemas.voter import VoterResponse
        ...
        for field in OLD_ADDRESS_FIELDS:
            assert field not in fields, (
                f"VoterResponse still exposes old field {field!r}"
            )
...
class TestVoterCreateRequestHasAllNewFields:
    ...
    def test_voter_create_request_has_all_new_fields(self):
        """VoterCreateRequest exposes all new fields."""
    ...
    def test_voter_create_request_does_not_have_old_address_fields(self):
        ...
        for field in OLD_ADDRESS_FIELDS:
            assert field not in fields, (
                f"VoterCreateRequest still exposes old field {field!r}"
            )
...
class TestVoterUpdateRequestHasAllNewFields:
    ...
    def test_voter_update_request_has_all_new_fields(self):
        """VoterUpdateRequest exposes all new fields."""
    ...
    def test_voter_update_request_does_not_have_old_address_fields(self):
        ...
        for field in OLD_ADDRESS_FIELDS:
            assert field not in fields, (
                f"VoterUpdateRequest still exposes old field {field!r}"
            )
...
class TestVoterFilterUsesRegistrationPrefix:
    ...
    def test_voter_filter_has_registration_prefixed_address_fields(
        self,
    ):
        """VoterFilter exposes registration_ prefixed
        address fields."""
    ...
    def test_voter_filter_does_not_have_old_address_fields(self):
        ...
        for old_field in ("city", "state", "zip_code", "county"):
            assert old_field not in fields, (
                f"VoterFilter still has old field {old_field!r}"
            )
...
class TestVoterSchemaSerializationRoundtrip:
    ...
    def test_voter_create_request_roundtrip_with_new_fields(
        self,
    ):
        """VoterCreateRequest correctly serializes and
        deserializes all new field groups."""
        from app.schemas.voter import VoterCreateRequest
    ...
    def test_voter_filter_roundtrip_with_registration_fields(
        self,
    ):
        """VoterFilter correctly serializes and
        deserializes registration_ prefixed fields."""
        from app.schemas.voter_filter import VoterFilter
